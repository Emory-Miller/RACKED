  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="rackedApp.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="rackedApp.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('rackedApp.location.distanceFromUser')}
                id="location-distanceFromUser"
                name="distanceFromUser"
                data-cy="distanceFromUser"
                type="text"
              />
              <ValidatedField
                label={translate('rackedApp.location.gpsCoordinates')}
