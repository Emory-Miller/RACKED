          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="rackedApp.review.rack">Rack</Translate>
                </th>
                <th>
                  <Translate contentKey="rackedApp.review.location">Location</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {reviewList.map((review, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{review.rack ? <Link to={`/rack/${review.rack.id}`}>{review.rack.id}</Link> : ''}</td>
                  <td>{review.location ? <Link to={`/location/${review.location.id}`}>{review.location.id}</Link> : ''}</td>
