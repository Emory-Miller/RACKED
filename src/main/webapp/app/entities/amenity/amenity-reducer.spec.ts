...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './amenity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AMENITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_AMENITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AMENITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AMENITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AMENITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AMENITY actions', async () => {
      const expectedActions = [
        {
