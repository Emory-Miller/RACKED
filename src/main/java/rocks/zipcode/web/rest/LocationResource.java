...
/**
 * REST controller for managing {@link rocks.zipcode.domain.Location}.
 */
@RestController
@RequestMapping("/api")
@Transactional
        ...
        Optional<Location> result = locationRepository
            ...
            .map(existingLocation -> {
                if (location.getDistanceFromUser() != null) {
                    existingLocation.setDistanceFromUser(location.getDistanceFromUser());
                }
                if (location.getGpsCoordinates() != null) {
                    existingLocation.setGpsCoordinates(location.getGpsCoordinates());
                }
