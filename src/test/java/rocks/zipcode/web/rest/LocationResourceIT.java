...
import rocks.zipcode.repository.LocationRepository;
...
class LocationResourceIT {
    ...
    private static final Integer DEFAULT_DISTANCE_FROM_USER = 1;
    private static final Integer UPDATED_DISTANCE_FROM_USER = 2;
    ...
    public static Location createEntity(EntityManager em) {
        Location location = new Location().distanceFromUser(DEFAULT_DISTANCE_FROM_USER).gpsCoordinates(DEFAULT_GPS_COORDINATES);
        return location;
    }
    ...
    public static Location createUpdatedEntity(EntityManager em) {
        Location location = new Location().distanceFromUser(UPDATED_DISTANCE_FROM_USER).gpsCoordinates(UPDATED_GPS_COORDINATES);
        return location;
    }
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getDistanceFromUser()).isEqualTo(DEFAULT_DISTANCE_FROM_USER);
        assertThat(testLocation.getGpsCoordinates()).isEqualTo(DEFAULT_GPS_COORDINATES);
    }
    ...
    void getAllLocations() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.[*].distanceFromUser").value(hasItem(DEFAULT_DISTANCE_FROM_USER)))
    ...
    void getLocation() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.distanceFromUser").value(DEFAULT_DISTANCE_FROM_USER))
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.distanceFromUser(UPDATED_DISTANCE_FROM_USER).gpsCoordinates(UPDATED_GPS_COORDINATES);
        ...
        Location testLocation = locationList.get(locationList.size() - 1);
        assertThat(testLocation.getDistanceFromUser()).isEqualTo(UPDATED_DISTANCE_FROM_USER);
        assertThat(testLocation.getGpsCoordinates()).isEqualTo(UPDATED_GPS_COORDINATES);
    }
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.distanceFromUser(UPDATED_DISTANCE_FROM_USER);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.distanceFromUser(UPDATED_DISTANCE_FROM_USER).gpsCoordinates(UPDATED_GPS_COORDINATES);
