...
import rocks.zipcode.domain.Image;
import rocks.zipcode.repository.ImageRepository;
...
class ImageResourceIT {
    ...
    public static Image createEntity(EntityManager em) {
        Image image = new Image().imageLocation(DEFAULT_IMAGE_LOCATION).image(DEFAULT_IMAGE).imageContentType(DEFAULT_IMAGE_CONTENT_TYPE);
        return image;
    }
    ...
    public static Image createUpdatedEntity(EntityManager em) {
        Image image = new Image().imageLocation(UPDATED_IMAGE_LOCATION).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
        return image;
    }
    ...
    void putExistingImage() throws Exception {
        ...
        updatedImage.imageLocation(UPDATED_IMAGE_LOCATION).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
    ...
    void partialUpdateImageWithPatch() throws Exception {
        ...
        partialUpdatedImage.image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
    ...
    void fullUpdateImageWithPatch() throws Exception {
        ...
        partialUpdatedImage.imageLocation(UPDATED_IMAGE_LOCATION).image(UPDATED_IMAGE).imageContentType(UPDATED_IMAGE_CONTENT_TYPE);
